...
import com.wbt.utils.ExcelConvertPdfUtil;
...
public class Excel2PDFTest {
    private static final String path = "D:\\projects\\sjb\\externalDemo\\src\\main\\resources";
    ...
    public static void main(String[] args) throws Exception {
        ...
        ExcelConvertPdfUtil.convertPdf(workbook, fos, pageSize);
    }
}